---
title: "Project Phoenix learnR Session 1 UNAM"
author: "Dr Mark Kelson - University of Exeter"
date: "12 June 2017"
output: pdf_document
---
...
## Manipulating data
Once a dataset has been imported we can start interrogating it. If we know the variable name we can examine it on it's own. Say we want to look at the number variable in the delegates data. We would type
```{r eval=F}
my.data$number
```
...
![Reshaping data with the melt() and cast() functions](//Users//Mark//Documents//Cardiff//Teaching//R//learnR//Handbook//reshaping-data-using-melt-and-cast.png) 
...
![](//Users//Mark//Documents//Cardiff//Teaching//R//learnR//Handbook//Economist1.png) 
